...
ZMPT101B currentSensor(34, 50.0);
...
pinMode(SW_2,OUTPUT);
  voltageSensor.setSensitivity(SENSITIVITY);
    currentSensor.setSensitivity(SENSITIVITY);
...
void loop()
{
 ...
 current=currentSensor.getRmsVoltage();
 Serial.print(voltage);
Serial.println(" volts");
Serial.print(current);
Serial.println(" milli ampere");
...
value=adc1_get_raw(ADC_PIN);
        ...
        temperatures=(value/4095.0)*3300.0;
        temperatures=temperatures/10.0;
